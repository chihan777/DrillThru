...
const FALLBACK_PROJECTS = [
  ...
  { id: 4, title: "KrishiConnect Platform", category: "Full Stack", description: "Connecting farmers directly to consumers, eliminating middlemen and ensuring fair prices for agricultural products.", image: null, link: "https://example.com", color: "from-lime-500/20 to-emerald-500/20", order: 4 },
]
