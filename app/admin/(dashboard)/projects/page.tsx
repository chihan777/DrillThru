    ...
    <>
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="admin-heading text-2xl sm:text-3xl">Projects</h1>
          <p className="admin-muted mt-1">Drag the arrows to reorder how projects appear on the homepage</p>
        </div>
        <Link href="/admin/projects/new" className="admin-btn-primary flex w-fit items-center gap-2 px-5 py-2.5 text-sm">
